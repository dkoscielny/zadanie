(function orders(){
    ...
    var VAT = 23,
        ...
        addToTheBasket = function(){
            var $tbody = $('.basket__table > tbody'),
            $tr = $('<tr></tr>');
